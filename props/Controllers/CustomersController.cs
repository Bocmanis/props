...
namespace props.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Number,Name,Surname,Age,PhoneNumber,GenderId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Number,Name,Surname,Age,PhoneNumber,GenderId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
